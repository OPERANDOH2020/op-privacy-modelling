 ...
 * two data fields, and two roles with access policies on these fields.
 */

public class SimpleModelTwoFieldGeneration {

    private final static String FILENAME = "unittests/twoDataFields.xml";
    /**
